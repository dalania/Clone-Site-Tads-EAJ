    ...
    <Container >
      ...
      <Content data-aos="fade-up">
          ...
          <p>
            ...
            competências e 28 habilidades. Segundo o Catálogo Nacional de Cursos Superiores de Tecnologia este profissional 
            analisa, projeta, desenvolve, testa, implanta e mantém sistemas computacionais de informação.
            Avalia, seleciona, específica e utiliza metodologias, tecnologias e ferramentas da Engenharia de Software,
            linguagens de programação e bancos de dados.Coordena equipes de produção de softwares. Vistoria, realiza perícia,
            avalia, emite laudo e parecer técnico em sua área de formação.Ele analisa, projeta, documenta,especifica, testa,
            implanta e mantém sistemas computacionais de informação. Este profissional trabalha, também, com ferramentas computacionais,
            equipamentos de informática e metodologia de projetos na produção de sistemas. Raciocínio lógico, emprego de
            linguagens de programação e de metodologias de construção de projetos, preocupação com a qualidade,
            usabilidade, robustez, integridade e segurança de programas computacionais são fundamentais à atuação deste 
            profissional.Adicionalmente, as seguintes características são referência para a atuação deste profissional
            (Portaria INEP n. 477, 6 junho 2017):
      ...
      <Content>
      <h3> Competências e Habilidades do Profissional </h3>
      <p> 
      ...
      <ul>
        <li> 
          interpretar e elaborar documentos, gráficos, tabelas e diagramas
        </li>
      ...
      <h3> Metodologia </h3>
      <p> 
        Os princípios pedagógicos, filosóficos e legais que subsidiam a organização dos cursos superiores de tecnologia definidos pelo MEC, nos quais a relação teoria-prática
         é o princípio fundamental, associados à estrutura curricular do curso superior de Tecnologia em Análise e Desenvolvimento de Sistemas, conduzem a um fazer pedagógico
          no qual atividades como seminários, visitas técnicas, práticas laboratoriais e desenvolvimento de projetos entre outros estão presentes em todos os períodos letivos.
      ...
      <p className="modify"> A política de melhoria da qualidade dos cursos de Graduação (Resolução No 181/2017-CONSEPE) e de Pós-Graduação oferecidos pela UFRN é um instrumento
         de fortalecimento da missão institucional. Nesse sentido, o Curso deve elaborar um Plano de Ação Trienal do Curso de Graduação (PATCG), propondo estratégias
          para enfrentamento das fragilidades e encaminhamentos de melhorias dos indicadores.
      </p>
      <p className="modify">
        A presente atualização do Projeto Pedagógico foi uma das medidas apontadas no Plano de Ação Trienal do Curso de Graduação (PATCG) de Tecnologia em Análise
         e Desenvolvimento de Sistemas recém-desenvolvido, com vigência no período 2018-2019. 57 Adicionalmente, em conformidade com o previsto no artigo 9º.
      </p>
